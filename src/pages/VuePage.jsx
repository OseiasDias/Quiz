...
import perguntasAngular from "../data/PeguntasVue.js";
  ...
  return (
    <section className="seccao-home text-white">
        ...
        <div className="row ">
          <div className="header d-flex justify-content-between">
            <a href="#" className="d-block itens arrajoItens">
              <FaVuejs className="fs-3" style={{ color: "#b366ff" }} />
              &nbsp;Vue.js
            </a>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            {perguntaAtual.alternativas.map((alternativa, idx) => (
              <button
                key={idx}
                className={`text-start text-white d-block itens w-100 activada7 ${selected === idx ? 'selected' : ''}`}
      ...
      >
        ...
        {index === perguntasAngular.length && (
          <div>
            ...
            <button onClick={handleCloseModal} className="itens text-white mx-auto d-block mt-3" style={{backgroundColor:"#b366ff"}}>Fechar e voltar para o início</button>
          </div>
        )}
      </Modal>
      ...
      >
        ...
        <button onClick={confirmExit} className="mx-2 itens text-white" style={{backgroundColor: "#b366ff"}}>Sim</button>
        <button onClick={cancelExit} className="mx-2 itens text-white" style={{backgroundColor: "gray"}}>Não</button>
      </Modal>
    </section>
  );
}
