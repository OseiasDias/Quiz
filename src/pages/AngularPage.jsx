...
import perguntasAngular from "../data/PeguntasAngular.js";
...
export default function AngularPage() {
      ...
      <div className="container pt-5">
        <div className="row ">
          ...
          <a href="#" className="d-block itens arrajoItens">
              <FaAngular  className="fs-3" style={{ color: "#66ff66" }} />
              &nbsp;Angular
            </a>
          ...
          <div className="col-12 col-md-6 col-lg-6">
            {perguntaAtual.alternativas.map((alternativa, idx) => (
              <button
                key={idx}
                className={`text-start text-white d-block itens w-100 activada6 ${selected === idx ? 'selected' : ''}`}
      ...
      >
        ...
        {index === perguntasAngular.length && (
          <div>
            ...
            <button onClick={handleCloseModal} className="itens text-white mx-auto d-block mt-3" style={{backgroundColor:"#66ff66"}}>Fechar e voltar para o início</button>
          </div>
        )}
      </Modal>
 ...
 <button onClick={confirmExit} className="mx-2 itens text-white" style={{backgroundColor: "#66ff66"}}>Sim</button>        <button onClick={cancelExit} className="mx-2 itens text-white" style={{backgroundColor: "gray"}}>Não</button>
      </Modal>
    </section>
  );
}
